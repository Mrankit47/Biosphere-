...
export const ROUTE_META: Record<string, { label: string; icon: string }> = {
  ...
  "/cell-explorer": { label: "Cell Explorer", icon: "🔬" },
  "/microorganisms": { label: "Microorganisms", icon: "🦠" },
  "/viruses": { label: "Viruses", icon: "☣️" },
  "/disease-explorer": { label: "Disease Explorer", icon: "🏥" },
  "/rare-species": { label: "Rare Species", icon: "🦁" },
  "/dna-genetics": { label: "DNA & Genetics", icon: "🧬" },
  "/human-body": { label: "Human Body", icon: "🫀" },
  ...
  "/process-simulations": { label: "Process Sims", icon: "🌀" },
  "/research-hub": { label: "Research Hub", icon: "📚" },
  "/tutor": { label: "AI Tutor", icon: "🤖" },
  "/dictionary": { label: "Dictionary", icon: "📖" },
