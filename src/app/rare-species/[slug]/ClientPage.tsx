...
export default function ClientPage({ slug }: { slug: string }) {
  ...
  if (!species) {
    return (
      <div style={{ height: "calc(100vh - 64px)", display: "flex", alignItems: "center", justifyContent: "center", background: "#050A05", flexDirection: "column", gap: "16px" }}>
        ...
        <Link href="/rare-species" style={{ color: "rgba(200,245,200,0.7)", fontSize: "0.85rem", textDecoration: "none", padding: "8px 20px", borderRadius: "10px", border: "1px solid rgba(57,255,20,0.2)", background: "rgba(5,10,5,0.5)" }}>← Back to Collection</Link>
      </div>
    );
  }
  ...
  return (
    <div style={S.root}>
      ...
      {/* Back */}
      <Link href="/rare-species" style={S.backLink}>
...
const S: Record<string, React.CSSProperties> = {
  ...
  hint: { position: "absolute", bottom: 40, left: "50%", transform: "translateX(-50%)", zIndex: 10, color: "rgba(57,255,20,0.35)", fontSize: "0.72rem", letterSpacing: "0.1em", pointerEvents: "none" },
  panel: { position: "absolute", top: 80, right: 20, zIndex: 10, width: "min(320px, 80vw)", display: "flex", flexDirection: "column", gap: "10px", padding: "18px", borderRadius: "16px", background: "rgba(5,10,5,0.85)", backdropFilter: "blur(20px)", border: "1px solid rgba(57,255,20,0.08)", maxHeight: "calc(100vh - 200px)", overflowY: "auto" },
